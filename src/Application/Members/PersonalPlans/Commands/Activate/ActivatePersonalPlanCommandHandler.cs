...
public class ActivatePersonalPlanCommandHandler(
    ...
    IClock clock)
    : ICommandHandler<ActivatePersonalPlanCommand, PersonalPlanDto>
{
    ...
    /// <inheritdoc />
    public Task<PersonalPlanDto> Handle(ActivatePersonalPlanCommand request, CancellationToken cancellationToken)
    {
