    ...
    ILogger<DownloadAvatarJob> logger) : IJob
{
    ...
    [LoggerMessage(Level = LogLevel.Warning, Message = "Invalid job data: MemberId={MemberId}, UrlString={RawUrl}")]
    private partial void LogInvalidJobData(string? memberId, string? rawUrl);
