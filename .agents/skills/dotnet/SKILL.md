...
- **String Normalization (SonarQube S4040):** Always normalize strings to uppercase using `ToUpperInvariant()` instead of `ToLowerInvariant()`. This applies universally across the project to comply with SonarQube rule csharpsquid:S4040.
